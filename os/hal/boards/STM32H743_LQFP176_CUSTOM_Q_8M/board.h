 ...
 * Board identifier.
 */
#define BOARD_STM32H743_LQFP176_CUSTOM_Q_8M
#define BOARD_NAME                  "STM32H743 LQFP176 Custom Q 8M"
...
#define GPIOA_MXH_S1                 GPIOA_PIN4
#define GPIOA_MXH_S0                 GPIOA_PIN5
#define GPIOA_MXH_S2                 GPIOA_PIN6
#define GPIOA_MXH_ANALOG2            GPIOA_PIN7
...
#define GPIOC_FMC_SDNWE              GPIOC_PIN0
#define GPIOC_FMC_SDNE0              GPIOC_PIN2
#define GPIOC_FMC_SDCKE0             GPIOC_PIN3
#define GPIOC_MXH_ANALOG1            GPIOC_PIN4
...
#define LINE_MXH_S1                  PAL_LINE(GPIOA, 4U)
#define LINE_MXH_S0                  PAL_LINE(GPIOA, 5U)
#define LINE_MXH_S2                  PAL_LINE(GPIOA, 6U)
#define LINE_MXH_ANALOG2             PAL_LINE(GPIOA, 7U)
...
#define LINE_MXH_ANALOG1             PAL_LINE(GPIOC, 4U)
 ...
 * PA2  - PIN2                      (analog).
 * PA3  - PIN3                      (analog).
 * PA4  - MXH_S1                    (output pushpull).
 * PA5  - MXH_S0                    (output pushpull).
 * PA6  - MXH_S2                    (output pushpull).
 * PA7  - MXH_ANALOG2               (analog).
 * PA8  - ENC2_A                    (input).
...
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_SAI2_SD_B) |  \
                                     ...
                                     PIN_MODE_ANALOG(GPIOA_MXH_ANALOG2) |   \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_SAI2_SD_B) |   \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_MXH_ANALOG2) |\
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_SAI2_SD_B) |     \
                                     ...
                                     PIN_OSPEED_VERYLOW(GPIOA_MXH_ANALOG2) |\
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_SAI2_SD_B) |  \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_MXH_ANALOG2) |\
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_SAI2_SD_B, 10U) |    \
                                     ...
                                     PIN_AFIO_AF(GPIOA_MXH_ANALOG2, 0U))
 ...
 * PC15 - PIN15                     (analog).
 */
#define VAL_GPIOC_MODER             (FMC_PIN_MODE(GPIOC_FMC_SDNWE) |       \
                                     PIN_MODE_ANALOG(GPIOC_PIN1) |         \
                                     FMC_PIN_MODE(GPIOC_FMC_SDNE0) |       \
                                     FMC_PIN_MODE(GPIOC_FMC_SDCKE0) |      \
...
#define VAL_GPIOC_OTYPER            (FMC_PIN_OTYPE(GPIOC_FMC_SDNWE) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN1) |       \
                                     FMC_PIN_OTYPE(GPIOC_FMC_SDNE0) |       \
                                     FMC_PIN_OTYPE(GPIOC_FMC_SDCKE0) |      \
...
#define VAL_GPIOC_OSPEEDR           (FMC_PIN_OSPEED(GPIOC_FMC_SDNWE) |     \
                                     PIN_OSPEED_VERYLOW(GPIOC_PIN1) |      \
                                     FMC_PIN_OSPEED(GPIOC_FMC_SDNE0) |     \
                                     FMC_PIN_OSPEED(GPIOC_FMC_SDCKE0) |    \
...
#define VAL_GPIOC_PUPDR             (FMC_PIN_PUPDR(GPIOC_FMC_SDNWE) |      \
                                     PIN_PUPDR_FLOATING(GPIOC_PIN1) |      \
                                     FMC_PIN_PUPDR(GPIOC_FMC_SDNE0) |      \
                                     FMC_PIN_PUPDR(GPIOC_FMC_SDCKE0) |     \
...
#define VAL_GPIOC_ODR               (FMC_PIN_ODR(GPIOC_FMC_SDNWE) |        \
                                     PIN_ODR_LOW(GPIOC_PIN1) |            \
                                     FMC_PIN_ODR(GPIOC_FMC_SDNE0) |        \
                                     FMC_PIN_ODR(GPIOC_FMC_SDCKE0) |       \
...
#define VAL_GPIOC_AFRL              (FMC_PIN_AF(GPIOC_FMC_SDNWE) |         \
                                     PIN_AFIO_AF(GPIOC_PIN1, 0U) |         \
                                     FMC_PIN_AF(GPIOC_FMC_SDNE0) |         \
                                     FMC_PIN_AF(GPIOC_FMC_SDCKE0) |        \
